...
|---|---|---|---|---|
|Glass|<img width="300" height="250" alt="model 1" src=https://github.com/user-attachments/assets/d10edfd0-8773-49ac-9521-0b6abd5e5ede>||Plastic|<img width="300" height="250" alt="model 1" src=https://github.com/user-attachments/assets/938d30cd-79d2-48cd-a713-eb66160842b2>| 
|Paper|<img width="300" height="250" alt="model 1" src=https://github.com/user-attachments/assets/dfd93204-5a2a-4bf7-bc98-2ea7d8784c9a>||Vegetation|<img width="300" height="250" alt="model 1" src=https://github.com/user-attachments/assets/65d35a08-45aa-4a14-9d86-4bea73c51b69>|
|Cardboard|<img width="300" height="250" alt="model 1" src=https://github.com/user-attachments/assets/c098c46c-9709-4295-a8b5-b501380d0224>||Metal|<img width="300" height="250" alt="model 1" src=https://github.com/user-attachments/assets/7b1743f4-56f4-4edf-acaf-829b81037ac8>|
...
Model 1 with ANN architecture fell short with no real classification power. The best Convolutional Artificial Neural Network model (CNN), model 3, returned an overall accuracy of 69% on unseen data (the test set). Its best performing class is 'Vegetaion' (85% accuracy) and worst performing class is 'Plastic'(54% accuracy).
